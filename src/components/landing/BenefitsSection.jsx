...
export default function BenefitsSection() {
  ...
  const beneficiosLeitura = {
    ...
    linguagem: {
      icon: <LuRocket className="w-10 h-10" />,
    ...
    <section className="py-24 relative overflow-hidden bg-white">
      ...
      <div className="container px-4 mx-auto">
        ...
        <p className="text-center text-lg max-w-3xl mx-auto mb-16">
          Descubra como o hábito da leitura pode mudar completamente sua vida, fortalecendo sua mente e ampliando seus horizontes.
        </p>

        {/* Tabs de navegação */}
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          <Button
            variant={activeTab === "conhecimento" ? "primary" : "outline"}
          ...
          <Button
            variant={activeTab === "linguagem" ? "primary" : "outline"}
          ...
          <Button
            variant={activeTab === "criatividade" ? "primary" : "outline"}
            onClick={() => setActiveTab("criatividade")}
            className="flex items-center gap-2 hover:scale-105"
          >
          ...
          {Object.entries(beneficiosLeitura).map(([key, beneficio]) => (
            <div
              ...
              className={`transition-all duration-500 ${
                activeTab === key ? "opacity-100 transform translate-x-0" : "opacity-0 absolute inset-0 transform translate-x-8"
              }`}
